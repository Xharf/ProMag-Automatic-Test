...
WebUI.click(findTestObject('Page_Home/anchor - Incoming Project'))

WebUI.verifyElementPresent(findTestObject('Page_IncomingProject/Text - title - Incoming Project'), 0)

WebUI.click(findTestObject('Page_IncomingProject/button - register yes (regist)'))
