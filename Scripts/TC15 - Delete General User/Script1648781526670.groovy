...
WebUI.click(findTestObject('Page_UserManagement/button - action - delete', [('row') : row]))

WebUI.verifyElementPresent(findTestObject('Page_UserManagement/Text - card header - Delete User'), 0)

WebUI.click(findTestObject('Page_UserManagement/button - delete - delete'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_UserManagement/Text - alert - Data Was Deleted'), 0)
